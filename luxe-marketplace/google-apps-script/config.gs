const CONFIG = {
  ...
  sheets: {
    ...
    Users: ["userId", "name", "email", "phone", "passwordHash", "role", "purchasedItems", "favorites", "createdAt", "status"],
    ...
    HtmlShowcases: ["indexId", "name", "slug", "priceRwf", "category", "previewTitle", "previewDescription", "backendSpec", "indexHtmlPath", "sourcePath", "previewImage", "status"],
    DbConnections: ["connectionId", "name", "type", "target", "status", "notes", "updatedAt"],
    PasswordResets: ["resetId", "identifier", "channel", "code", "userId", "expiresAt", "used", "createdAt"]
  }
};
